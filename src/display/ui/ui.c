...
lv_obj_t *ui_ProfileScreen_tempText1;
...
lv_obj_t *ui_MenuScreen_tempText2;
...
lv_obj_t *ui_StatusScreen_tempText5;
...
lv_obj_t *ui_BrewScreen_tempText3;
...
lv_obj_t *ui_SteamScreen_tempText4;
...
lv_indev_wait_release(lv_indev_get_act());
      _ui_screen_change( &ui_ProfileScreen, LV_SCR_LOAD_ANIM_MOVE_BOTTOM, 500, 0, &ui_ProfileScreen_screen_init);
}
}
void ui_event_MenuScreen_brewButton1( lv_event_t * e) {
    lv_event_code_t event_code = lv_event_get_code(e);lv_obj_t * target = lv_event_get_target(e);
