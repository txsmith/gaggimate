...
lv_arc_set_range(ui_MenuScreen_tempGauge, 0,145);
...
lv_arc_set_range(ui_MenuScreen_tempTarget, 0,145);
lv_arc_set_value(ui_MenuScreen_tempTarget, 110);
...
ui_MenuScreen_tempText2 = lv_label_create(ui_MenuScreen);
lv_obj_set_width( ui_MenuScreen_tempText2, LV_SIZE_CONTENT);  /// 1
lv_obj_set_height( ui_MenuScreen_tempText2, LV_SIZE_CONTENT);   /// 1
lv_obj_set_x( ui_MenuScreen_tempText2, 0 );
lv_obj_set_y( ui_MenuScreen_tempText2, -196 );
lv_obj_set_align( ui_MenuScreen_tempText2, LV_ALIGN_CENTER );
lv_label_set_text(ui_MenuScreen_tempText2,"92°C");
lv_obj_set_style_text_color(ui_MenuScreen_tempText2, lv_color_hex(0xFAFAFA), LV_PART_MAIN | LV_STATE_DEFAULT );
lv_obj_set_style_text_opa(ui_MenuScreen_tempText2, 255, LV_PART_MAIN| LV_STATE_DEFAULT);
lv_obj_set_style_text_font(ui_MenuScreen_tempText2, &lv_font_montserrat_18, LV_PART_MAIN| LV_STATE_DEFAULT);
...
lv_imgbtn_set_src(ui_MenuScreen_profileButton1, LV_IMGBTN_STATE_RELEASED, NULL, &ui_img_1759772909, NULL);
...
ui_object_set_themeable_style_property(ui_MenuScreen_profileButton1, LV_PART_MAIN| LV_STATE_DEFAULT, LV_STYLE_IMG_RECOLOR, _ui_theme_color_SemiDark);
ui_object_set_themeable_style_property(ui_MenuScreen_profileButton1, LV_PART_MAIN| LV_STATE_DEFAULT, LV_STYLE_IMG_RECOLOR_OPA, _ui_theme_alpha_SemiDark);
...
lv_obj_set_y( ui_MenuScreen_ImgButton2, 210 );
lv_obj_set_align( ui_MenuScreen_ImgButton2, LV_ALIGN_CENTER );
lv_obj_set_style_img_recolor(ui_MenuScreen_ImgButton2, lv_color_hex(0xFAFAFA), LV_PART_MAIN| LV_STATE_DEFAULT);
