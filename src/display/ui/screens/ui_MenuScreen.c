...
lv_img_set_angle(ui_MenuScreen_tempTarget,300);
...
lv_arc_set_value(ui_MenuScreen_tempGauge, 91);
...
lv_img_set_angle(ui_MenuScreen_pressureTarget,1705);
...
ui_object_set_themeable_style_property(ui_MenuScreen_grindButton1, LV_PART_MAIN| LV_STATE_DEFAULT, LV_STYLE_IMG_RECOLOR, _ui_theme_color_NiceWhite);
ui_object_set_themeable_style_property(ui_MenuScreen_grindButton1, LV_PART_MAIN| LV_STATE_DEFAULT, LV_STYLE_IMG_RECOLOR_OPA, _ui_theme_alpha_NiceWhite);
