...
void ui_ProfileScreen_screen_init(void)
{
    ...
    ui_object_set_themeable_style_property(ui_ProfileScreen_tempTarget, LV_PART_MAIN | LV_STATE_DEFAULT,
    ...
    ui_object_set_themeable_style_property(ui_ProfileScreen_profileChoices, LV_PART_MAIN | LV_STATE_DEFAULT,
    ...
    ui_object_set_themeable_style_property(ui_ProfileScreen_profileChoices, LV_PART_MAIN | LV_STATE_DEFAULT,
                                           LV_STYLE_BG_COLOR, _ui_theme_color_Transparent);
    ui_object_set_themeable_style_property(ui_ProfileScreen_profileChoices, LV_PART_MAIN | LV_STATE_DEFAULT,
                                           LV_STYLE_BG_OPA, _ui_theme_alpha_Transparent);
