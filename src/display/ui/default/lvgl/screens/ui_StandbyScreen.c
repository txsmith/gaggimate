...
lv_obj_t *ui_StandbyScreen = NULL;lv_obj_t *ui_StandbyScreen_Image1 = NULL;lv_obj_t *ui_StandbyScreen_time = NULL;lv_obj_t *ui_StandbyScreen_Container1 = NULL;lv_obj_t *ui_StandbyScreen_wifiIcon = NULL;lv_obj_t *ui_StandbyScreen_bluetoothIcon = NULL;lv_obj_t *ui_StandbyScreen_updateIcon = NULL;lv_obj_t *ui_StandbyScreen_Image3 = NULL;
// event funtions
