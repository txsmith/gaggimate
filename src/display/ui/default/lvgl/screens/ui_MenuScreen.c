...
void ui_MenuScreen_screen_init(void) {
    ...
    ui_object_set_themeable_style_property(ui_MenuScreen_tempTarget, LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_IMG_RECOLOR_OPA,
    ...
    ui_object_set_themeable_style_property(ui_MenuScreen_pressureTarget, LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_IMG_RECOLOR,
                                           _ui_theme_color_NiceWhite);
