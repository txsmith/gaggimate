...
void ui_WaterScreen_screen_init(void)
{
    ...
    ui_object_set_themeable_style_property(ui_WaterScreen_tempTarget, LV_PART_MAIN | LV_STATE_DEFAULT,
    ...
    ui_object_set_themeable_style_property(ui_WaterScreen_contentPanel6, LV_PART_MAIN | LV_STATE_DEFAULT,
    ...
    ui_object_set_themeable_style_property(ui_WaterScreen_targetTempHelp3, LV_PART_MAIN | LV_STATE_DEFAULT,
    ...
    ui_object_set_themeable_style_property(ui_WaterScreen_goButton, LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_IMG_RECOLOR,
                                           _ui_theme_color_NiceWhite);
    ui_object_set_themeable_style_property(ui_WaterScreen_goButton, LV_PART_MAIN | LV_STATE_DEFAULT,
                                           LV_STYLE_IMG_RECOLOR_OPA, _ui_theme_alpha_NiceWhite);
    ...
    ui_object_set_themeable_style_property(ui_WaterScreen_upTempButton, LV_PART_MAIN | LV_STATE_DEFAULT,
                                           LV_STYLE_IMG_RECOLOR, _ui_theme_color_NiceWhite);
    ui_object_set_themeable_style_property(ui_WaterScreen_upTempButton, LV_PART_MAIN | LV_STATE_DEFAULT,
                                           LV_STYLE_IMG_RECOLOR_OPA, _ui_theme_alpha_NiceWhite);
