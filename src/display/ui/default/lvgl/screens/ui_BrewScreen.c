...
lv_obj_t *ui_BrewScreen = NULL;lv_obj_t *ui_BrewScreen_dials = NULL;lv_obj_t *ui_BrewScreen_ImgButton5 = NULL;lv_obj_t *ui_BrewScreen_contentPanel4 = NULL;lv_obj_t *ui_BrewScreen_mainLabel3 = NULL;lv_obj_t *ui_BrewScreen_startButton = NULL;lv_obj_t *ui_BrewScreen_controlContainer = NULL;lv_obj_t *ui_BrewScreen_modeSwitch = NULL;lv_obj_t *ui_BrewScreen_timedButton = NULL;lv_obj_t *ui_BrewScreen_volumetricButton = NULL;lv_obj_t *ui_BrewScreen_profileInfo = NULL;lv_obj_t *ui_BrewScreen_Label1 = NULL;lv_obj_t *ui_BrewScreen_Container3 = NULL;lv_obj_t *ui_BrewScreen_profileName = NULL;lv_obj_t *ui_BrewScreen_profileSelectBtn = NULL;lv_obj_t *ui_BrewScreen_adjustments = NULL;lv_obj_t *ui_BrewScreen_tempContainer = NULL;lv_obj_t *ui_BrewScreen_targetTemp = NULL;lv_obj_t *ui_BrewScreen_downTempButton = NULL;lv_obj_t *ui_BrewScreen_upTempButton = NULL;lv_obj_t *ui_BrewScreen_Image5 = NULL;lv_obj_t *ui_BrewScreen_targetContainer = NULL;lv_obj_t *ui_BrewScreen_targetDuration = NULL;lv_obj_t *ui_BrewScreen_upDurationButton = NULL;lv_obj_t *ui_BrewScreen_downDurationButton = NULL;lv_obj_t *ui_BrewScreen_Image4 = NULL;
// event funtions
