...
#define UI_THEME_ACTIVE 1
                                                               ...
                                                               // inside this style should be garbage-collected (recommended
                                                               // value: 10..100, 0:never)
#define LV_SQUARELINE_THEME__EXPLICIT_GARBAGE_COLLECTOR_PERIOD                                                                   \
    10 // a sensible default value that already gives good results on slow hardware, can be overridden from outside
#endif
#endif
...
#ifdef LV_SQUARELINE_THEME__OBJECT_VALIDITY_CACHE // for slow hardware, adding this and setting to 5..10 in lv_conf.h might make
                                                  // it faster (less lv_obj_is_valid calls)
